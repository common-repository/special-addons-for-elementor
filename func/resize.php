...
add_action('delete_attachment', 'oew_delete_resized_images');

function oew_image_resize($url, $width = null, $height = null, $crop = true, $align = 'c', $retina = false) {
	global $wpdb;

	// Get common vars (func_get_args() only get specified values)
	$common = oew_common_info($url, $width, $height, $crop, $align, $retina);
...
function oew_common_info($url, $width, $height, $crop, $align, $retina) {
...
function oew_delete_resized_images($post_id) {
